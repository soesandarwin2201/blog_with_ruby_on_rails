...
RSpec.describe 'Test for the user show page', type: :system do 
 context ' Check the right content for user show page' do 
  before(:each) do
    @new_user = User.create(name: 'soe sandar win', photo: 'https://www.anisearch.de/images/character/cover/full/0/817.webp', bio: 'software engineer', postscounter: 0)
    @post_one = Post.create(author: @new_user, title: 'Hello', text: 'this is my first post', commentscounter: 0, likescounter: 0)
